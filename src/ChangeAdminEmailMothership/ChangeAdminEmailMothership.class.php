...
class ChangeAdminEmailMothership
{
    ...
    public function doSendTestEmail(){
        ...
        $message = file_get_contents('/var/www/generalchicken/wp-content/plugins/change-admin-email-setting-without-outbound-email/src/ChangeAdminEmailMothership/Email.html');
