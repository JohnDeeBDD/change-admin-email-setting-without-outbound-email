...
class ChangeAdminEmailPlugin{
    ...
    public function run(){
        ...
        //The default WP functionality is to send a confirmation email. This filter overrides the default behavior:
	    ...
	    //an email. We must check the nonce first before this action is completed:
